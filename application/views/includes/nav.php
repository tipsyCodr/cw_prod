...
<div class="  nav-bar navigation-bar flex justify-center w-full  fixed bottom-5 left-0 mx-auto  ">
    <div
        class="scale-90 wrapper p-1 max-w-[410px] bg-black filter bg-opacity-70 backdrop-blur-sm rounded-full shadow-lg ">
