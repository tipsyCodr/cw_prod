    ...
    <div class="wrapper ">
        <ul class="flex text-center p-2 justify-evenly items-center pb-4">
            <li><a href="<?= base_url('/') ?>" class=" nav-item w-full text-decoration-none ">
                    <img src="<?= base_url('assets/images/icons/home-page.png') ?>" alt="home icon" width="30em"
                        height="30em" />
                    <!-- <i
            ...
            <li><a href="<?= base_url('services') ?>" class=" nav-item w-full text-decoration-none">
                    <img src="<?= base_url('assets/images/icons/customer-line.png') ?>" alt="services icon" width="33em"
                        height="31em" />
                    <!-- <i
            ...
            <li><a href="<?= base_url('matrimonial') ?>" class=" nav-item w-full text-decoration-none">
                    <img src="<?= base_url('assets/images/icons/relationship-line.png') ?>" alt="matrimony icon"
