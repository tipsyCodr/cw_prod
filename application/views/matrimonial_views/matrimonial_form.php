                            ...
                            <div class="col-md-12">
                                <div class="form-group app-label mt-2">
                                    ...
                                    <input id="job_occupation" name="job_occupation" type="text"
                                        class="form-control resume" placeholder="Doctor"
                                        value="<?php echo set_value('job_occupation'); ?>">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group app-label mt-2">
                                    ...
                                    <select id="state" name="state" class="nice-select form-select">
                                    ...
                                    <?php echo form_error('state', '<div class="mb-4 mt-3 alert alert-danger">', '</div>'); ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group app-label mt-2">
                                    <label for="city" class="form-label text-muted">City</label>
                                    <select id="city" name="city" class="nice-select form-select">
                                        <option data-display="City">City</option>
                                        <?php
                                        if (!empty($city_list)) {
                                            foreach ($city_list as $city) {
                                                ?>
                                                <option value="<?php echo $city['id']; ?>" <?php echo set_select('city', $city['id']); ?>><?php echo $city['name']; ?></option>
                                                <?php
                                            }
                                        }
                                        ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group app-label mt-2">
                                        ...
                                        <input id="mother_tongue" name="mother_tongue" type="text"
                                            class="form-control resume" placeholder="Hindi"
                                            value="<?php echo set_value('mother_tongue'); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group app-label mt-2">
                                        ...
                                        <input id="education" name="education" type="text" class="form-control resume"
                                            placeholder="Graduation BSC" value="<?php echo set_value('education'); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group app-label mt-2">
                                        ...
                                        <input id="salary" name="salary" type="text" class="form-control resume"
                                            placeholder="20000 Rs / month" value="<?php echo set_value('salary'); ?>">
