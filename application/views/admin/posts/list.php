            ...
            <div class="card-body mb-5">
                <div class=' border-b-2 flex justify-evenly items-center'>
                    ...
                    <?php } else { ?>
                        <a class='bg-green-500 hover:bg-green-600 block w-full text-center text-white py-2'
                            ...
                            <i class="fa fa-lock hover:text-red-500 transition-all "></i><span class="text-lg"> Unban Post </span>
                        </a>
                    <?php } ?>
                ...
                <div class="flex justify-start my-2">
                    <div class="flex items-center gap-x-2">
                        ...
                        <?php } else { ?>
                            <p class=" rounded-full text-white" data-id="<?= $blog_id; ?>"><i class="fa fa-heart text-red-400 "></i>
                            </p>
                        <?php } ?>
