                ...
                <div class="post-job bg-white p-4">
                    <div class="custom-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group app-label mt-2">
                                    <label for="country" class="text-muted">State</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group app-label mt-2">
                                    ...
                                    <input id="business_image" name="business_image" type="file"
                                        class="custom-file-input" value="<?php echo set_value('business_image'); ?>">
